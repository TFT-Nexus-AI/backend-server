...
public class Match {
    ...
    public static Match of(Long id, String matchId, Long gameDatetime, Float gameLength, String gameVersion, String tftSet) {
        return new Match(id, matchId, gameDatetime, gameLength, gameVersion, tftSet);
    }

    public LocalDateTime getGameDateTime() {
        return gameDatetime != null ? LocalDateTime.ofInstant(Instant.ofEpochMilli(gameDatetime), ZoneOffset.UTC) : null;
    }

    public boolean isRecentMatch() {
        if (gameDatetime == null) return false;
